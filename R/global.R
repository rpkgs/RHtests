...
#     files <- dir(dir, "*.r|*.R", full.names = TRUE)
#     for (file in files) {
#         eval(substitute(source(file, encoding = "UTF-8"), list(file = file)), envir = env_pkg)
#     }
# }

# source_dir("R/plot")
# source_dir("R/OnChange")
# source_dir("R/main")

# source('R/global/constant.R')
