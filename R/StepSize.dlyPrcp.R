StepSize.dlyPrcp<-function(InSeries, InCs, output,
  MissingValueCode="-999.99",GUI=FALSE, pthr=0,Mq=10,plev=0.95,Iadj=10000,Ny4a=0)
{
  ErrorMSG<-NA
  Ncat.min<-20
